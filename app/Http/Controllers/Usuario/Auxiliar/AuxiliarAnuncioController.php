...
class AuxiliarAnuncioController extends Controller
{
    private $actividades;
    private $publicaciones;
    private $estado = 1;
    private $tipo = 'Auxiliatura';
    ...
    public function indice()
    {
        ...
        return view('usuario.auxiliar.anuncios', compact('anuncios'));
    }
    public function publicar(Request $request)
    {
        ...
        if ($publicarAnuncio) {
            ...
            return to_route('auxiliar.anuncios');
        }
        $this->actividades->registrarActividad(
            Auth::User()->usuario_id,
            $modulo = 'Auxiliares - Anuncios',
