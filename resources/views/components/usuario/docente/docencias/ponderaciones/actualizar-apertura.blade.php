<form action="{{route('docente.ponderaciones.actualizar-apertura')}}" method="POST" class="flex">
    @csrf
    ...
    <div class="input-field">
        <input type="number" name="ponderacion_principal" value={{$ponderacionPrincipal}} min="1" max="100" placeholder="Placeholder" id="ponderacion-principal-{{$campo[0]}}" type="text" class="validate">
