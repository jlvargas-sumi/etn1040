        ...
        <tbody>
            ...
            @foreach ($asignaturas as $asignatura)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('docente.ponderaciones', [$asignatura->apertura_id, $periodo, $gestion])}}" class="sin-estilo btn-azul p-5 waves-effect waves-light" title="Administrar Asignatura">
