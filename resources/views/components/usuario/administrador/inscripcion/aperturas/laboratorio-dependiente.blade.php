<div id="modal-laboratorio-dependiente" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Cambiar a Laboratorio dependiente</span>
        <form action="{{route('administrador.aperturas.laboratorio-dependiente')}}" method="POST" id="laboratorio-dependiente">
            @csrf
            <div class="row">
