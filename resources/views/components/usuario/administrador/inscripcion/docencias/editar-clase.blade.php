<div id="modal-editar-clase" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Actualizar clase para <strong id="sigla"></strong></span>
        <form action="{{route('administrador.docencias.actualizar-clase')}}" method="POST">
            @csrf
            <div class="row">
                ...
                <input type="hidden" name="clase_actual" required >
                <div class="tabla-s">
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>Clase</td>
                                <td id="clase-actual"></td>
                                <td><input type="number" name="clase" id="clase" min="2" max="10" step="1" class="validate" required></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
