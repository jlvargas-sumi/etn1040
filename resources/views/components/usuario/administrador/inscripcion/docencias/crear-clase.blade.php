<div id="modal-crear-clase" class="modal">
    <div class="modal-content">
        <h4>Crear clase para <strong></strong></h4>
        <form action="{{route('administrador.docencias.crear-clase')}}" method="POST">
            @csrf
            <div class="row">
                ...
                <div class="input-field col s6">
                    <input type="number" name="clase" value="3" min="3" max="10" class="validate" required>
                    <label for="inscripcion">Clase</label>
                </div>
