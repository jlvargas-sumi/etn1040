<div id="modal-reiniciar-clave" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Reiniciar Contraseña</span>
        <form action="{{route('administrador.usuarios.reiniciar-clave')}}" method="POST">
            @csrf
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td id="nombres"></td>
                        <td>
                            <button type="submit" class="btn waves-effect waves-light">Reiniciar Contraseña</button>
                        </td>
                    </tr>
                </tbody>
            </table>
