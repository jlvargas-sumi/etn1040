<div id="modal-eliminar-estudiante" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Eliminar Estudiante</span>
        <form action="{{route('administrador.estudiantes.eliminar')}}" method="POST">
            @csrf
