<div id="modal-editar-datos-docente" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Editar datos</span>
        <form action="{{route('administrador.docentes.actualizar')}}" method="POST">
            @csrf
            ...
            <div class="tabla-s">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>Grado</td>
                            <td id="grado-actual"></td>
                            <td>
                                <select class="browser-default" name="grado" class="validate" required>
                        ...
                        <tr>
                            <td>Categoría</td>
                            <td id="categoria-actual"></td>
                            <td>
                                <select class="browser-default" name="categoria_id" class="validate" required>
