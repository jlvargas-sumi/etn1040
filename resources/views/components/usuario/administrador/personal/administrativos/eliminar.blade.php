<div id="modal-eliminar-administrativo" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Eliminar administrativo</span>
        <form action="{{route('administrador.administrativos.eliminar')}}" method="POST">
            @csrf
