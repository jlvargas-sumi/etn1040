<div id="modal-editar-mencion" class="modal">
    <div class="modal-content">
        <span class="subtitulo">Editar datos</span>
        <form action="{{route('administrador.menciones.actualizar')}}" method="POST">
            @csrf
            ...
            <div class="tabla-s">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>Mención</td>
                            <td id="mencion-actual"></td>
                            <td><input type="text" name="mencion" id="mencion" class="validate" required></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
