        ...
        <tbody>
            @foreach ($anuncios as $i => $anuncio)
                ...
                <tr>
                    ...
                    <x-usuario.auxiliar.anuncios.modal-archivo :i="$i" :recurso-archivo="$recursoArchivo" :ruta-archivo="$rutaArchivo" :anuncio="$anuncio" />
                    <x-usuario.auxiliar.anuncios.modal-editar :i="$i" :anuncio="$anuncio" />
                    <x-usuario.auxiliar.anuncios.modal-eliminar :i="$i" :anuncio="$anuncio" />
            @endforeach
        </tbody>
    </table>
</div>