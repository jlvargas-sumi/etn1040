<h4 id="titulo-principal">
    HORARIOS CORRESPONDIENTES AL PERIODO ACADÉMICO {{ $periodo }} - {{ $gestion }} (UNIV. {{ $estudiante->persona_primer_apellido }} {{ $estudiante->persona_segundo_apellido }} {{ $estudiante->persona_nombres }})
</h4>
